...
CENTER_J2000_RA_HOURS = (
    "06:00:00.0"  # RA coordinates at the center of the grid, in J2000 hours
)
...
TAKE_IMAGE_AT_EACH_GRIDPOINT = (
    False  # If True, Maxim DL will be used to take an image at each target
)
        ...
        if RECORD_COORDINATES:
            ...
            print(
                ...
                % (
                    ...
                    target_dec_j2000_degs,
                    target_ra_jnow_hours,
                    target_dec_jnow_degs,
                ),
                file=coords_file,
            )
            coords_file.close()
...
def make_raster_scan_grid(
    ...
    for i in range(num_dec_rows):
        ...
        for j in range(num_ra_columns):
            ...
            if equal_sky_angle:
                ra_offset_degs = ra_offset_degs / math.cos(
                    convert.degs_to_rads(target_dec_degs)
                )
