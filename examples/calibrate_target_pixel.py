...
TARGET_RA_J2000_HOURS = "14:15:38.402" # RA coordinates of the target star, in J2000 hours
TARGET_DEC_J2000_DEGS = "+19:10:21.839" # Dec coordinates of the target star, in J2000 degrees

EXPOSURE_LENGTH_SECONDS = 10            # Exposure length of each image, in seconds

ARCSEC_PER_PIXEL_UNBINNED = 0.81       # Estimated image scale of UNBINNED image, in arcseconds per pixel
