...
# Divide a fits CCD 2D image by another with 32-bit float output
...
if len(sys.argv) == 1:
  print ""
  print "Usage: fits_divide.py in1.fits in2.file.fits outfile.fits"
  print ""
  sys.exit("Divide one image by another \n")
elif len(sys.argv) == 4:
  in1file = sys.argv[1]
  in2file = sys.argv[2]
  outfile = sys.argv[3]
