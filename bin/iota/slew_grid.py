...
CENTER_J2000_RA_HOURS = "10:00:00"  # RA coordinates at the center of the grid, in J2000 hours
CENTER_J2000_DEC_DEGS = "70:00:00"  # Dec coordinates at the center of the grid, in J2000 degrees
...
RA_GRID_SPACING_ARCSEC = 30         # RA spacing between each gridpoint, in arcseconds
DEC_GRID_SPACING_ARCSEC = 30        # Dec spacing between each gridpoint, in arcseconds
...
PROMPT_BEFORE_STARTING_NEXT_TARGET = True # If True, script will wait for user to hit Enter before moving to each new target

TAKE_IMAGE_AT_EACH_GRIDPOINT = True # If True, Maxim DL will be used to take an image at each target
