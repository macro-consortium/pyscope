...
TARGET_RA_J2000_HOURS = "01:09:44.120" # RA coordinates of the target star, in J2000 hours
TARGET_DEC_J2000_DEGS = "35:37:12.126" # Dec coordinates of the target star, in J2000 degrees
TARGET_PIXEL_X_UNBINNED = 976.513       # Target X pixel position in unbinned image. Center of the top left corner pixel is (1, 1)
TARGET_PIXEL_Y_UNBINNED = 3216.331     # Target Y pixel position in unbinned image. Center of the top left corner pixel is (1, 1)
...
SYNC_MOUNT = True                      # If True, the entire coordinate system of the mount will be offset (i.e. offsets apply to future slews)
