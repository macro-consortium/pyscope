...
class _TelrunGUI(ttk.Frame):
    ...
    def _build_gui(self):
        ttk.Label(self, text='System Status', font=self._gui_font).grid(row=0, column=0, columnspan=3, sticky='new')
        self.system_status_widget = _SystemStatusWidget(self)
        self.system_status_widget.grid(row=1, column=0, columnspan=3, sticky='sew')

        ttk.Label(self, text='Previous Block', font=self._gui_font).grid(row=2, column=0, columnspan=1, sticky='sew')
        self.previous_block_widget = _BlockWidget(self)
        self.previous_block_widget.grid(row=3, column=0, columnspan=1, sticky='new')

        ttk.Label(self, text='Current Block', font=self._gui_font).grid(row=2, column=1, columnspan=1, sticky='sew')
        self.current_block_widget = _BlockWidget(self)
        self.current_block_widget.grid(row=3, column=1, columnspan=1, sticky='new')

        ttk.Label(self, text='Next Block', font=self._gui_font).grid(row=2, column=2, columnspan=1, sticky='sew')
