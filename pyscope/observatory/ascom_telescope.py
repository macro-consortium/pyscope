...
class ASCOMTelescope(Telescope):
    ...
    def DestinationSideOfPier(self, RightAscension, Declination):
        logger.debug(f"ASCOMTelescope.DestinationSideOfPier({RightAscension}, {Declination}) called")
    ...
    def SlewToCoordinates(self, RightAscension, Declination):
        logger.debug(f"ASCOMTelescope.SlewToCoordinates({RightAscension}, {Declination}) called")
        self._com_object.SlewToCoordinates(RightAscension, Declination)
    
    def SlewToCoordinatesAsync(self, RightAscension, Declination):
        logger.debug(f"ASCOMTelescope.SlewToCoordinatesAsync({RightAscension}, {Declination}) called")
    ...
    def SyncToCoordinates(self, RightAscension, Declination):
        logger.debug(f"ASCOMTelescope.SyncToCoordinates({RightAscension}, {Declination}) called")
