                    ...
                    dark_paths.append(
                        os.path.join(
                            ...
                            (
                                ...
                                % (readout, binning[0], binning[1], exposure, i)
                            ),
                        )
                    )
                ...
                reduction.avg_fits(
                    ...
                    outfile=os.path.join(
                        ...
                        (
                            ...
                            % (readout, binning[0], binning[1], exposure)
                        ),
                    ),
                    fnames=dark_paths,
                )
                    ...
                    flat_paths.append(
                        os.path.join(
                            ...
                            (
                                ...
                                % (filt, readout, binning[0], binning[1], exposure, i)
                            ),
                        )
                    )
